...
test.describe('User login to Swag Labs', () => {
  ...
  test('Successful login as Locked out user', async ({ page }) => {
    // Act
  ...
  test('Successful login as Problem user', async ({ page }) => {
    // Act
  ...
  test('Unsuccessful login with incorrect login', async ({ page }) => {
    // Act
